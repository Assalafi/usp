                        ...
                        <div class="row">
                            <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                                <div class="alert alert-primary text-center p-3">
                                    <h4 class="mb-1">
                                        {{ session('appointment') == 'DSO' ? $applicants->where('department', session('department'))->count() : $applicants->count() }}
                                    </h4>
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                                <div class="alert alert-warning text-center p-3">
                                    <h4 class="mb-1">
                                        {{ session('appointment') == 'DSO' ? $pending->where('department', session('department'))->count() : $pending->count() }}
                                    </h4>
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                                <div class="alert alert-info text-center p-3">
                                    <h4 class="mb-1">
                                        {{ session('appointment') == 'DSO' ? $submitted->where('department', session('department'))->count() : $submitted->count() }}
                                    </h4>
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                                <div class="alert alert-success text-center p-3">
                                    <h4 class="mb-1">
                                        {{ session('appointment') == 'DSO' ? $admitted->where('department', session('department'))->count() : $admitted->count() }}
                                    </h4>
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                                <div class="alert alert-success text-center p-3">
                                    <h4 class="mb-1">
                                        {{ session('appointment') == 'DSO' ? $cleared->where('department', session('department'))->count() : $cleared->count() }}
                                    </h4>
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                                <div class="alert alert-danger text-center p-3">
                                    <h4 class="mb-1">
                                        {{ session('appointment') == 'DSO' ? $rejected->where('department', session('department'))->count() : $rejected->count() }}
                                    </h4>
                    ...
                    @if (session('accType') == 'Admin')
                        <div class="card-block">
                            ...
                            <button href="#" class="btn btn-dark uploadAction" data-bs-toggle="modal"
                                data-bs-target="#importStudent"><i class="fas fa-upload"></i>
                                {{ 'Upload' }}</button>
                            <button href="#" class="btn btn-dark uploadAction" data-bs-toggle="modal"
                                data-bs-target="#admitStudent"><i class="fas fa-file"></i> {{ 'Admit' }}</button>
                            ...
                            <div class="row gx-2">
                                ...
                                @if (session('accType') == 'Admin')
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <select class="form-control department" id="departmentf" name="department" lang="f">
                                            <option value="">All Departments</option>
                                            @if (isset($departments) && ($filters['faculty'] ?? ''))
                                                @foreach ($departments as $dept)
                                                    <option value="{{ $dept->code }}"
                                                        {{ ($filters['department'] ?? '') == $dept->code ? 'selected' : '' }}>
                                                        {{ $dept->title }}
                                                    </option>
                                                @endforeach
                                            @endif
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <select class="form-control program" id="programf" name="program" lang="f">
                                            <option value="">All Programs</option>
                                            @if (isset($programs) && ($filters['department'] ?? ''))
                                                @foreach ($programs as $prog)
                                                    <option value="{{ $prog->code }}"
                                                        {{ ($filters['program'] ?? '') == $prog->code ? 'selected' : '' }}>
                                                        {{ $prog->title }}
                                                    </option>
                                                @endforeach
                                            @endif
                                ...
                                <div class="form-group col-md-1">
                                    ...
                                    <select class="form-control" id="statusf" name="status">
                                        ...
                                        <option value="Pending"
                                            {{ ($filters['status'] ?? '') == 'Pending' ? 'selected' : '' }}>Pending
                                        </option>
                                        <option value="Submitted"
                                            {{ ($filters['status'] ?? '') == 'Submitted' ? 'selected' : '' }}>Submitted
                                        </option>
                                        <option value="Admitted"
                                            {{ ($filters['status'] ?? '') == 'Admitted' ? 'selected' : '' }}>Admitted
                                        </option>
                                        <option value="Rejected"
                                            {{ ($filters['status'] ?? '') == 'Rejected' ? 'selected' : '' }}>Rejected
                                        </option>
                                    </select>
                                </div>
                                ...
                                <!-- Status Filter -->
                                <div class="form-group col-md-1">
                                    <label for="clearancef">Clearance</label>
                                    <select class="form-control" id="clearancef" name="clearance">
                                        <option value="">All Clearance</option>
                                        <option value="Pending"
                                            {{ ($filters['clearance'] ?? '') == 'Pending' ? 'selected' : '' }}>Pending
                                        </option>
                                        <option value="Cleared"
                                            {{ ($filters['clearance'] ?? '') == 'Cleared' ? 'selected' : '' }}>Cleared
                                        </option>
                                        <option value="Rejected"
                                            {{ ($filters['clearance'] ?? '') == 'Rejected' ? 'selected' : '' }}>
                                            Rejected
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <select class="form-control" id="modef" name="mode">
                                        ...
                                        <option value="UTME"
                                            {{ ($filters['mode'] ?? '') == 'UTME' ? 'selected' : '' }}>UTME</option>
                                        <option value="DE"
                                            {{ ($filters['mode'] ?? '') == 'DE' ? 'selected' : '' }}>DE</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <select class="form-control" id="session" name="session">
                                        ...
                                        @foreach ($session as $sess)
                                            <option value="{{ $sess->title }}"
                                                {{ ($filters['session'] ?? '') == $sess->title ? 'selected' : '' }}>
                                                {{ $sess->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <tbody>
                                    ...
                                    @forelse ($data as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="badge badge-{{ $row->mode == 'UTME' ? 'primary' : 'secondary' }}">
                                                    {{ $row->mode }}
                                                </span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <!-- View Details Button -->
                                                <a href="/admin-applicant/{{ $row->id }}"
                                                    class="btn btn-info btn-sm" title="View Details">
                                                    <i class="far fa-eye"></i>
                                                </a>

                                                <!-- Quick Status Actions -->
                                                @if ($row->status == 'Rejecteds' || $row->status == 'Submitteds')
                                                    <!-- Admit Button -->
                                        ...
                                        <div id="admitApplicant{{ $row->id }}" class="modal fade"
                                                    ...
                                                    <form action="/admin/admit-applicant" method="POST">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="alert alert-success">
                                                                ...
                                                                <strong>{{ $row->fullname }}</strong> to
                                                                <strong>{{ DB::table('program')->where('code', $row->program)->value('title') }}</strong>.
                                                            </div>

                                                            <div class="form-group">
                                                                <label
                                                                    for="admission_remarks{{ $row->id }}">Admission
                                                                    Remarks (Optional)</label>
                                                                <textarea class="form-control" id="admission_remarks{{ $row->id }}" name="remarks" rows="3"
                                        ...
                                        <div id="rejectApplicant{{ $row->id }}" class="modal fade"
                                            tabindex="-1" role="dialog">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="/admin/reject-applicant" method="POST">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="alert alert-danger">
                                                                ...
                                                                <strong>{{ $row->fullname }}</strong>'s application for
                                                                <strong>{{ DB::table('program')->where('code', $row->program)->value('title') }}</strong>.
                                                            </div>

                                                            <div class="form-group">
                                                                <label
                                                                    for="rejection_reason{{ $row->id }}">Reason
                                                                    for Rejection <span
                                                                        class="text-danger">*</span></label>
                                                                <select class="form-control"
                                                                    id="rejection_reason{{ $row->id }}"
                                                                    name="rejection_reason" required>
                                                                    <option value="">Select rejection reason...
                                                                    </option>
                                                                    <option value="Insufficient JAMB Score">
                                                                        Insufficient JAMB Score</option>
                                                                    <option value="Poor SSCE Results">Poor SSCE Results
                                                                    </option>
                                                                    <option value="Missing Required Documents">Missing
                                                                        Required Documents</option>
                                                                    <option value="Program Capacity Full">Program
                                                                        Capacity Full</option>
                                                                    <option value="Failed to Meet Entry Requirements">
                                                                        Failed to Meet Entry Requirements</option>
                                                                    <option value="Incomplete Application">Incomplete
                                                                        Application</option>
                                                                    <option value="Other">Other (Specify in remarks)
                                                                    </option>
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <label
                                                                    for="rejection_remarks{{ $row->id }}">Additional
                                                                    Remarks</label>
                                                                <textarea class="form-control" id="rejection_remarks{{ $row->id }}" name="remarks" rows="3"
...
<div id="admitStudent" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel">Admit Students</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
            </div>
            <div class="card">

                <form class="form-group" action="/admit-student-upload" method="POST"
                    enctype="multipart/form-data">
                    <div class="card-body">
                        <!-- Details View Start -->
                        @csrf
                        <div class="form-group">
                            <label for="facultya">Faculty</label>
                            <select class="form-control faculty" id="facultya" name="faculty" lang="a"
                                required>
                                <option value="">Select Option</option>
                                @foreach ($faculty as $row)
                                    <option value="{{ $row->code }}">{{ $row->title }}</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control department" id="departmenta" name="department"
                                lang="a" required>
                                <option value="">Select Faculty First</option>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" id="programa" name="program" lang="a" required>
                                <option value="">Select Department First</option>
                            </select>
                        </div>
                        <div class="form-group">
