                    ...
                    <div class="row gx-2">
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control" name="lga" id="lga" required>
                                ...
                                @foreach ($lga as $roww)
                                    <option value="{{ $roww->local_name }}">{{ $roww->local_name }}</option>
                                @endforeach
                            </select>
                            <div class="invalid-feedback"> You must select LGA </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="lgas" name="lga" required>
                                <option value="">Select Option</option>
                                @foreach ($lga as $position)
                                    <option value="{{ $position->local_name }}">{{ $position->local_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
