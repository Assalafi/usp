                ...
                <div class="card">
                    ...
                    <div class="card-block d-flex align-items-center gap-2 flex-wrap">
                        ...
                        <div class="ms-auto d-flex align-items-center gap-2">
                            <label class="mb-0 fw-bold">Certificate Type:</label>
                            <select id="certTypeSelect" class="form-select form-select-sm" style="width:auto;">
                                <option value="1" {{ session('cert_type', '1') == '1' ? 'selected' : '' }}>Type 1</option>
                                <option value="2" {{ session('cert_type', '1') == '2' ? 'selected' : '' }}>Type 2</option>
                                <option value="3" {{ session('cert_type', '1') == '3' ? 'selected' : '' }}>Type 3</option>
                            </select>
                            <label class="mb-0 fw-bold ms-3">Background:</label>
                            <select id="certBgSelect" class="form-select form-select-sm" style="width:auto;">
                                <option value="1" {{ session('cert_bg', '1') == '1' ? 'selected' : '' }}>With Background</option>
                                <option value="0" {{ session('cert_bg', '1') == '0' ? 'selected' : '' }}>Without Background</option>
                            </select>
                            <span id="certTypeStatus" class="badge bg-success d-none">Saved</span>
                        </div>
                    </div>
...
<script>
function saveCertSetting() {
    var status = document.getElementById('certTypeStatus');
    fetch('/set-cert-type', {
        method: 'POST',
        headers: {
        ...
        body: JSON.stringify({
            cert_type: document.getElementById('certTypeSelect').value,
            cert_bg: document.getElementById('certBgSelect').value
        })
    })
    ...
    .then(data => {
        if (data.success) {
            ...
            setTimeout(function() { status.classList.add('d-none'); }, 2000);
        }
    });
}
