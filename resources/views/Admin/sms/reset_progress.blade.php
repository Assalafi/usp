<div class="card">
    <div class="card-header">
        <h3 class="card-title">Password Reset and Notification Progress</h3>
    </div>
    <div class="card-body">
        ...
        <div class="mt-3">
            <a href="{{ route('sms.non_academic_staff') }}" class="btn btn-secondary">Back to Staff List</a>
        </div>
    </div>
</div>
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const eventSource = new EventSource("{{ route('sms.reset_and_notify_stream') }}");
