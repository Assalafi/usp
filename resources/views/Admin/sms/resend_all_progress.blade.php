<div class="card">
    <div class="card-header">
        <h3 class="card-title">Bulk SMS Resend Progress</h3>
    </div>
    <div class="card-body">
        ...
        <div class="mt-3">
            <a href="{{ route('sms.sent') }}" class="btn btn-secondary">Back to Sent SMS</a>
        </div>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Preserve the query string from the previous page
        const urlParams = new URLSearchParams(window.location.search);
        const eventSource = new EventSource("{{ route('sms.resend_all_stream') }}?" + urlParams.toString());
