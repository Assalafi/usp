                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $row)
                                        <tr>
                                            <td>{{ $sn++ }}</td>
                                            <td>{{ $row->name }}</td>
                                            <td>{{ $row->from_session }}</td>
                                            <td>{{ $row->to_session }}</td>
                                            <td>
                                        ...
                                        <div id="updateStudent{{ $row->id }}" class="modal fade" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-sm" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="card">
                                                        <form class="form-group" action="update-course-structure"
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="name"
                                                                        value="{{ $row->name }}" id="name"
                                                                        class="form-control" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="from_session">From Session</label>
                                                                    <select class="form-control" id="from_session"
                                                                        name="from_session" required>
                                                                        <option value="{{ $row->from_session }}">Select
                                                                            Option ({{ $row->from_session }})</option>
                                                                        @for ($i = 2000; $i <= 3000; $i++)
                                                                            <option value="{{ $i }}">
                                                                                {{ $i }}</option>
                                                                        @endfor
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="to_session">To Session</label>
                                                                    <select class="form-control" id="to_session"
                                                                        name="to_session" required>
                                                                        <option value="{{ $row->to_session }}">Select
                                                                            Option ({{ $row->to_session }})</option>
                                                                        @for ($i = 2000; $i <= 3000; $i++)
                                                                            <option value="{{ $i }}">
                                                                                {{ $i }}</option>
                                                                        @endfor
                                            ...
                                            <div class="modal-dialog modal-sm" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="card text-center">
                                                        ...
                                                        <form class="form-group" action="delete-course_structure"
                                                            method="POST" enctype="multipart/form-data">
                                                            <div class="card-body">
                                                                <!-- Details View Start -->
                                                                @csrf
...
<div id="create" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="card">
                <form class="form-group" action="create-course-structure" method="POST"
                    enctype="multipart/form-data">
                    <div class="card-body">
                        <!-- Details View Start -->
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="from_session">From Session</label>
                            <select class="form-control" id="from_session" name="from_session" required>
                        ...
                        <div class="form-group">
                            <label for="to_session">To Session</label>
                            <select class="form-control" id="to_session" name="to_session" required>
                                <option value="">Select Option</option>
                                @for ($i = 2000; $i <= 3000; $i++)
                                    <option value="{{ $i }}">{{ $i }}</option>
                                @endfor
