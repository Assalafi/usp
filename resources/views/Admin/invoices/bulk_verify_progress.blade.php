        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>Bulk Verify RRR</h5>
                        <span>Verifying all pending RRRs for service type {{ $serviceTypeId }}</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="/fees due">Fees Collection</a></li>
                        <li class="breadcrumb-item active">Bulk Verify</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Bulk Verification Progress - Service Type
                                        {{ $serviceTypeId }}</h3>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        <a href="/fees due" class="btn btn-secondary">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const eventSource = new EventSource("{{ route('admin.bulk_verify_stream') }}?serviceTypeId=" +
            serviceTypeId);
        ...
        eventSource.addEventListener('progress', function(e) {
            ...
            li.innerHTML =
                `<span class="${colorClass}">[${new Date().toLocaleTimeString()}] ${data.message}</span>`;
            logList.appendChild(li);
            logContainer.scrollTop = logContainer.scrollHeight;
        ...
        eventSource.addEventListener('finished', function(e) {
            ...
            // Update final status
            statusMessage.textContent = data.message;
            statusMessage.className = data.message.includes('Error') ? 'alert alert-warning' :
                'alert alert-success';
            ...
            const li = document.createElement('li');
            li.innerHTML =
                `<strong class="text-primary">[${new Date().toLocaleTimeString()}] ${data.message}</strong>`;
            logList.appendChild(li);
            logContainer.scrollTop = logContainer.scrollHeight;
        ...
        eventSource.onerror = function(e) {
            ...
            const li = document.createElement('li');
            li.innerHTML =
                `<span class="text-danger">[${new Date().toLocaleTimeString()}] Connection error occurred</span>`;
            logList.appendChild(li);
