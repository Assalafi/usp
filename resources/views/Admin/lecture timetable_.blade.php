                ...
                @isset ($_GET['faculty'])
                    <div class="card">
                        ...
                        <ul class="nav nav-pills mb-3 card-block" id="myTab" role="tablist">
                            ...
                            @endforeach
                            <li>
                                <a href="/lecture-timetable/{{ $_GET['faculty'] }}" class="btn btn-primary btn-sm nav-link">Preview</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade @if($weekday == 1) show active @endif" id="day{{ $weekday }}" role="tabpanel" aria-labelledby="day{{ $weekday }}-tab">
                                <div class="">
                                    <div class="row">
                                        <div class="col-md-12">
                                        @forelse($data->where('day_no' , $weekday)->where('faculty' , $_GET['faculty']) as $row)
<div class="card-block" id="deleteRoutine-{{ $row->id }}">
    <form class="formD" method="POST">
        ...
        <div class="row">
            ...
            @isset($row)
            <div class="form-group col-md-2">
                  <div class="btn btn-danger btn-filter deleteAction" onclick="deleteRoutine({{ $row->id }})">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-2">
                  <button id="removeField" type="button" class="btn btn-danger btn-filter"><i class="fas fa-trash-alt"></i> Remove</button>
                                        ...
                                        <div class="card-block createAction">
                            ...
                            @endforeach
                            <div class="card-footer text-right updateAction">
...
<script type="text/javascript">
    ...
    var course = '';
        ...
        $(document).on('click', '#addField', function () {
            ...
            html += '<input type="text" name="day_no" value="'+day_no+'" hidden><input type="text" name="day" value="'+day+'" hidden><input type="text" name="faculty" value="'+faculty+'" hidden> </div></form>';
