                                                    ...
                                                    <form class="form-group" action="update {{ $page }}" method="POST" enctype="multipart/form-data">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="class" id="class" lang="1" class="form-control" required>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="description" value="{{ $row->description }}" id="description" class="form-control" required>
                                                            </div>
                                                            <div class="form-group">
            ...
            <div class="card">
                <form class="form-group" action="create {{ $page }}" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="ncoa">NCOA</label>
                            <input type="text" name="ncoa" id="ncoa" class="form-control" maxlength="4" required>
                        </div>
                        <!-- Details View End -->
                    <button type="button" class="btn btn-info" data-bs-dismiss="modal">Close</button>
