                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="position" id="position"
                                                                        class="form-control"
                                                                        value="{{ $row->position }}" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="category">Category</label>
                                                                    <select class="form-control" id="category"
                                                                        name="category" required>
                                                                        <option value="{{ $row->category }}">Select
                                                                            Option</option>
                                                                        <option value="General">General (SUG) Election
                                                                        </option>
                                                                        <option value="Faculty Rep">Faculty Reps
                                                                        </option>
                                                                        <option value="Hostel Rep">Hostel Reps</option>
                                                                    </select>
                                                                </div>
                                                                <div class="form-group">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="category" name="category" required>
                                ...
                                <option value="General">General (SUG) Election</option>
                                <option value="Faculty Rep">Faculty Reps</option>
                                <option value="Hostel Rep">Hostel Reps</option>
                                <option value="Lga Rep">LGA Reps</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="order">Order</label>
