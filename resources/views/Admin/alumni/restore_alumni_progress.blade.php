<div class="card">
    <div class="card-header">
        <h3 class="card-title">Restoring Alumni to Students Progress</h3>
    </div>
    <div class="card-body">
        ...
        <div class="mt-3">
            <a href="{{ route('alumni.index') }}" class="btn btn-secondary">Back to Alumni List</a>
        </div>
    </div>
</div>
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const eventSource = new EventSource("{{ route('alumni.restore_alumni_stream') }}");
