                            ...
                            <table id="export-table" class="display table nowrap table-striped table-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    @php
                                        ...
                                        $amount = (($row -> cost) * $per) * getMonthsDiff($startDate, $endDate);
                                    @endphp
                                    <tr>
                                        <td>{{ $sn++ }}</td>
                                        <td>{{ $row -> class }}</td>
            ...
            <div class="card">
                <form class="form-group" action="create {{ $page }}" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="class">Class</label>
                            <select name="class" id="class" lang="c" class="form-control fixedClass" required>
                                <option value="">Select Option</option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="description" id="descriptionc" class="form-control" required>
