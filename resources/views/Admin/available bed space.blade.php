                                ...
                                <form action="#" method="GET">
                                    ...
                                    <div class="row gx-2">
                                        ...
                                        <div class="form-group col-md-4">
                                            <select class="form-control" id="filterHalls" name="hall" required>
                                        ...
                                        <div class="form-group col-md-4">
                                            <select class="form-control" name="category" id="filterCategorys">
                                        ...
                                        <div class="form-group col-md-3">
                                            <select class="form-control" name="bed_type" id="filterCategorys" required>
                                                <option value="1">SELECT RESERVE TYPE</option>
