                        ...
                        <div class="table-responsive">
                            <table id="export-table" class="display table nowrap table-striped table-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $sn++ }}</td>
                                        <td>{{ DB::table('faculty')->where('code', $row -> faculty)->select('title')->value('title') }}</td>
                                        <td>{{ $row -> hall }}</td>
                                        <td>{{ $row -> start_at }}</td>
                                        <td>{{ $row -> end_at }}</td>
                                        <td>
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="hall" id="hall" required>
                                                                    <option value="{{ $row -> hall }}">Select Option</option>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="time" name="start_at" value="{{ $row -> start_at }}" id="start_at" class="form-control" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="end_at">To</label>
                                                                <input type="time" name="end_at" value="{{ $row -> end_at }}" id="end_at" class="form-control" required>
                                                            </div>
                                                            <!-- Details View End -->
            ...
            <div class="card">
                <form class="form-group" action="create {{ $page }}" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="start_at">From</label>
                            <input type="time" name="start_at" value="07:00" id="start_at" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="end_at">To</label>
                            <input type="time" name="end_at" value="18:00" id="end_at" class="form-control" required>
                        </div>
                        <!-- Details View End -->
                    <button type="button" class="btn btn-info" data-bs-dismiss="modal">Close</button>
