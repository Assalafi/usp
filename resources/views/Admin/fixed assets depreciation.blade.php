                                                    ...
                                                    <form class="form-group" action="update {{ $page }}" method="POST" enctype="multipart/form-data">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="class" value="{{ $row->class }}" id="class" class="form-control" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="ncoa">NCOA</label>
                                                                <input type="text" name="ncoa" value="{{ $row->ncoa }}" id="ncoa" class="form-control" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="depreciation">Depreciation %</label>
                                                                <input type="number" name="depreciation" value="{{ $row->depreciation }}" id="depreciation" class="form-control" step="0.01" maxlength="6" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="life">Useful Life Yearly</label>
                                                                <input type="number" name="life" value="{{ $row->life }}" id="life" class="form-control" required>
                                                            </div>
                                                            <!-- Details View End -->
            ...
            <div class="card">
                <form class="form-group" action="create {{ $page }}" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="ncoa">NCOA</label>
                            <input type="text" name="ncoa" id="ncoa" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="depreciation">Depreciation %</label>
                            <input type="number" name="depreciation" id="depreciation" class="form-control" maxlength="6" step="0.01" required>
                        </div>
                        <div class="form-group">
                            <label for="life">Useful Life Yearly</label>
                            <input type="number" name="life" id="life" class="form-control" required>
                        </div>
                        <!-- Details View End -->
                    <button type="button" class="btn btn-info" data-bs-dismiss="modal">Close</button>
