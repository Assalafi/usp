@php
    //$flag = DB::table('students')->select('vflag')->where('user_id', session('id'))->value('vflag');
...
@if (strtoupper(session('state')) == strtoupper($vState) || $vState == 'ALL')
    @if ($school_fee == 1)
        @if ($flag == 0)
        ...
        @if ($flag == 1)
            ...
            @if (!$vote && strtoupper($status) == 'OPEN' && strtoupper($vType) == 'STUDENT')
                <div class="main-body">
                                                ...
                                                @foreach ($poss->where('category', $category) as $pos)
                                                    <div class="tab-pane fade @if ($active == 1) show active @endif"
                                                        ...
                                                        <div class="card-deck row">
                                                            @foreach ($data->where('category', $category)->where('position', $pos->position)->where('acc_type', session('accType')) as $row)
            ...
            @else
                @if (strtoupper($status) == 'OPEN' && strtoupper($vType) == 'STUDENT')
                    <h5>
                        Dear Voter {{ session('name') }},
                        <br><br>
                        We are pleased to inform you that the results of the election will be available immediately
                        after
                        the voting ends.
                        <br><br>
