            ...
            @if ($studentResults->isNotEmpty())
                ...
                <section class="ug-result-layer ug-detail-layer" aria-labelledby="detailTitle">
                    ...
                    <div class="ug-results-toolbar">
                        ...
                        <div class="ug-results-toolbar-actions"><label class="ug-results-search"><i class="fas fa-search"></i><input id="resultSearch" type="search" placeholder="Search results" autocomplete="off"></label><button type="button" class="ug-results-print" onclick="window.print()"><i class="fas fa-print"></i><span>Print</span></button></div>
                    </div>
                    <div id="resultGroups">
...
<style>
    ...
    @media (max-width:767px){.ug-results-filter-bar{display:block;padding:11px 12px;margin-bottom:9px}.ug-results-filter-bar .ug-results-session{margin-top:10px;min-width:0}.ug-results-toolbar-actions{display:block}.ug-results-toolbar-actions .ug-results-search{margin-top:10px}.ug-results-toolbar-actions .ug-results-print{width:100%;margin-top:8px}}
</style>
