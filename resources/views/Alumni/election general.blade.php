@php
    //$flag = DB::table('alumni')->select('id')->where('user_id', session('id'))->value('id');
...
@if ($flag == 1 && strtoupper($vType) == 'ALUMNI')
    @if ($school_fee == 1)
        @if ($flag == 0)
        ...
        @if ($flag == 1)
            ...
            @if (!$vote && strtoupper($status) == 'OPEN' && strtoupper($vType) == 'ALUMNI')
                <div class="main-body">
            ...
            @else
                @if (strtoupper($status) == 'OPEN' && strtoupper($vType) == 'ALUMNI')
                    <h5>
