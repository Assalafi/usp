...
$table = new easyTable($pdf, '{13, 30, 80, 40, 80}', 'width:170; border-color:black; font-size:10; border:1; paddingY:0.5;');
...
$table->easyCell('Degree: ' . $award . ' (Hons) ' . ucwords(strtolower($dept)), 'colspan:7; font-size:12; align:L;border:0;');
