...
$table->easyCell("SN");
$table->easyCell("CODE");
$table->easyCell("TITLE", 'colspan:2;');
$table->easyCell("UNIT");
...
foreach ($regs as $reg) {
    ...
    $table->easyCell(DB::table('course')->where(['code' => $reg->code])->value('title'), 'colspan:2;');
...
$pdf->Ln(5);
$table->easyCell("STUDENT'S SIGNATURE: .............................................................................................................................", 'colspan:6; font-size:10; align:L;border:0;');
$table->printRow();
$pdf->Ln(5);
$table->easyCell("HOD'S SIGNATURE:        .................................................................................................................................", 'colspan:6; font-size:10; align:L;border:0;');
$table->printRow();
$pdf->Ln(5);
$table->easyCell("REGISTRAR'S SIGNATURE: ..........................................................................................................................", 'colspan:6; font-size:10; align:L;border:0;');
$table->printRow();
