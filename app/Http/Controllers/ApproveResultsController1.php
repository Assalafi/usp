...
class ApproveResultsController extends Controller
{
    ...
    public function index(Request $req)
    {
        ...
        if (session('appointment') == 'vc' || session('accType') == 'Admin') {
    ...
    public function generateStatus(Request $req)
    {
        ...
        try {
            ...
            // Output progress in a single line
            echo "Processed: $processedStudents / $totalStudents | Remaining: $remainingStudents";
            ...
            return <<<HTML
                    <script>
                        // Display a message indicating the delay
                        document.write("Waiting 1 second before processing the next batch... ");
