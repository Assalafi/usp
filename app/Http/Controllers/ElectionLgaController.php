...
class ElectionLgaController extends Controller
{
    //
    //
    ...
    public function index(Request $req)
    {
        ...
        $data['lga'] = DB::table('locals')->where(['state_id' => '8'])->select('local_name')->distinct()->orderBy('local_name', 'ASC')->get();
        $data['category'] = 'Lga Rep';
        $data['page'] = $this->page;
